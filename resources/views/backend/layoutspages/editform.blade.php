        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    ...
                    <input class="form-control" placeholder="Layout Title" value="{{$layoutsPage[0]->layout_title}}" required="required" name="layout_title" type="text" id="layout_title">
            ...
            <div class="form-group row">
                ...
                @if(!empty($layoutsPage[0]->layout_image))
                <div class="col-lg-1">
                    <img src="{{ asset('storage/img/layout/'.$layoutsPage[0]->layout_image) }}" height="80" width="80">
                    <input class="form-control" placeholder="Layout Title" value="{{$layoutsPage[0]->layout_image}}" required="required" name="layout_image_old" type="hidden" id="layout_image_old">
                </div>
                <div class="col-lg-5">
