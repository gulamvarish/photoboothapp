...
<body class="app header-fixed sidebar-fixed aside-menu-off-canvas sidebar-lg-show">
    ...
    <div class="app-body">
        ...
        <main class="main">
            ...
            <?php if(Request::segment(2).Request::segment(3) != 'layoutspagesedit' && Request::segment(2).Request::segment(3) != 'photo-eventsedit' && Request::segment(2).Request::segment(3) != 'photo-eventsqrcodegenrate') {?>
               {!! Breadcrumbs::render() !!}
            <?php } ?>
