...
trait PhotoEventAttributes
{
    ...
    public function getActionButtonsAttribute()
    {
        return '<div class="btn-group action-btn">
                    '.$this->getEditButtonAttribute('edit-photo-event', 'admin.photo-events.edit').'                    
                    '.$this->getDeleteButtonAttribute('delete-photo-event', 'admin.photo-events.destroy').'
                </div>';
    }
